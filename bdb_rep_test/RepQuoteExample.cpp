...
void RepQuoteExample::init(RepConfigInfo *config) {
    ...
    // TODO
    // set reconnection timeout to 10 sec.
    cur_env.rep_set_timeout(DB_REP_CONNECTION_RETRY, 10*1000*1000);
...
void RepQuoteExample::event_callback(DbEnv* dbenv, u_int32_t which, void *info)
{
    ...
    {
        case DB_EVENT_PANIC:
            std::cout << "Ignoring DB_EVENT_PANIC" << std::endl;
            break;
        ...
        case DB_EVENT_REP_DUPMASTER:
            std::cout << "Ignoring DB_EVENT_REP_DUPMASTER" << std::endl;
            break;
        case DB_EVENT_REP_ELECTED:
            std::cout << "Ignoring DB_EVENT_REP_ELECTED" << std::endl;
            break;
        case DB_EVENT_REP_ELECTION_FAILED:
            std::cout << "Ignoring DB_EVENT_REP_ELECTION_FAILED" << std::endl;
            break;
        case DB_EVENT_REP_JOIN_FAILURE:
            std::cout << "Ignoring DB_EVENT_REP_JOIN_FAILED" << std::endl;
            break;
        case DB_EVENT_REP_MASTER_FAILURE:
            //TODO
            std::cout << "Ignoring DB_EVENT_REP_MASTER_FAILURE" << std::endl;
            break;
        case DB_EVENT_REP_CLIENT:
            app->is_master = 0;
            app->in_client_sync = 1;
            std::cout << "I'm now a client." << std::endl;
            break;
        case DB_EVENT_REP_MASTER:
            app->is_master = 1;
            app->in_client_sync = 0;
            std::cout << "I'm now the master!" << std::endl;
            break;
        case DB_EVENT_REP_NEWMASTER:
            app->in_client_sync = 1;
            std::cout << "A new master is elected!" << std::endl;
            break;
        ...
        case DB_EVENT_REP_STARTUPDONE:
            app->in_client_sync = 0;
            std::cout << "replication startup done!" << std::endl;
            break;
        default:
